    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          const targetWidth = entry.target.parentElement.getAttribute('data-width') || 
    ...
    diagramNodes.forEach(node => {
      node.addEventListener('mouseenter', () => {
        ...
        diagramLines.forEach(line => {
          if (line.getAttribute('data-from') === node.getAttribute('data-id') || 
  ...
  return (
    <div className="relative flex flex-col">
      ...
      <div className="relative z-10">
        ...
        <section id="services" className="py-24 relative border-t border-b border-white/10 section-gradient-blue">
          ...
          <div className="floating-badge" style={{ top: '15%', right: '10%' }}>AI-Powered</div>
          <div className="floating-dot" style={{ top: '30%', left: '15%' }}></div>
          <div className="floating-dot" style={{ bottom: '25%', right: '20%' }}></div>
          <div className="floating-line" style={{ top: '40%', left: '5%', transform: 'rotate(30deg)' }}></div>
          <div className="floating-line" style={{ bottom: '30%', right: '5%', transform: 'rotate(-20deg)' }}></div>
                ...
                >
                  ...
                  <div className="min-w-full px-4">
                    <div className="feature-card h-full">
                      ...
                      <div className="mb-6 flex justify-center">
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-glow">
                          <circle cx="60" cy="60" r="59" stroke="rgba(56, 189, 248, 0.2)" strokeWidth="2"/>
                          <circle cx="60" cy="60" r="40" stroke="rgba(56, 189, 248, 0.3)" strokeWidth="2"/>
                          <path d="M60 20V100" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2" strokeDasharray="4 4"/>
                          <path d="M20 60H100" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2" strokeDasharray="4 4"/>
                          <circle cx="60" cy="60" r="15" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="2"/>
                      ...
                      <h3 className="text-2xl font-bold text-white mb-4 text-center">Predictive Analytics</h3>
                      ...
                      <div className="mt-auto">
                        <a href="#contact" className="inline-block px-6 py-3 bg-[rgba(139,92,246,0.1)] backdrop-blur-sm border border-[rgba(139,92,246,0.2)] rounded-lg text-white hover:bg-[rgba(139,92,246,0.15)] transition-all">
                          Learn More
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="min-w-full px-4">
                    <div className="feature-card h-full">
                      ...
                      <div className="mb-6 flex justify-center">
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-glow">
                          <rect x="20" y="20" width="80" height="80" rx="4" stroke="rgba(56, 189, 248, 0.3)" strokeWidth="2"/>
                          ...
                          <rect x="30" y="50" width="25" height="40" rx="2" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2" className="svg-pulse"/>
                          <rect x="65" y="50" width="25" height="20" rx="2" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2"/>
                          <rect x="65" y="80" width="25" height="10" rx="2" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2"/>
                        </svg>
                      </div>
                      <h3 className="text-2xl font-bold text-white mb-4 text-center">Process Automation</h3>
                      <p className="text-xl text-gray-200 mb-8 max-w-2xl leading-relaxed font-light">
                        Streamline your business processes with our intelligent automation solutions. 
                        Reduce manual tasks, eliminate errors, and free your team to focus on 
                        high-value activities that drive growth.
                      </p>
                      <div className="mt-auto">
                        <a href="#contact" className="inline-block px-6 py-3 bg-[rgba(56,189,248,0.1)] backdrop-blur-sm border border-[rgba(56,189,248,0.2)] rounded-lg text-white hover:bg-[rgba(56,189,248,0.15)] transition-all">
                          Learn More
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="min-w-full px-4">
                    <div className="feature-card h-full">
                      ...
                      <div className="mb-6 flex justify-center">
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="svg-glow">
                          <path d="M30 90L60 30L90 90" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="2"/>
                          <circle cx="60" cy="30" r="10" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="2"/>
                          <circle cx="30" cy="90" r="10" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="2"/>
                          <circle cx="90" cy="90" r="10" fill="rgba(56, 189, 248, 0.1)" stroke="rgba(56, 189, 248, 0.5)" strokeWidth="2"/>
                          <circle cx="60" cy="60" r="20" fill="rgba(56, 189, 248, 0.05)" stroke="rgba(56, 189, 248, 0.3)" strokeWidth="2" strokeDasharray="4 4" className="svg-rotate"/>
                          <path className="svg-dash" d="M40 60H80" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2" strokeDasharray="4 4"/>
                          <path className="svg-dash" d="M60 40V80" stroke="rgba(56, 189, 248, 0.4)" strokeWidth="2" strokeDasharray="4 4"/>
                        </svg>
                      </div>
                      <h3 className="text-2xl font-bold text-white mb-4 text-center">Machine Learning</h3>
                      <p className="text-xl text-gray-200 mb-8 max-w-2xl">
                        Enhance customer experience with intelligent virtual assistants and chatbots.
                        Our AI-powered assistants provide 24/7 support, personalized recommendations,
                        and seamless interactions.
                      </p>
                      <div className="mt-auto">
                        <a href="#contact" className="inline-block px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white hover:bg-white/20 transition-all">
                          Learn More
                        </a>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-300 mb-8 leading-relaxed">
                  With years of experience in artificial intelligence and machine learning, 
                  our team delivers cutting-edge solutions that transform businesses across industries.
                </p>
              ...
              <div className="diagram-container h-[400px] relative">
                <div className="diagram-node" style={{top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 3}}>AI Core</div>
                <div className="diagram-node" style={{top: '20%', left: '30%'}}>Data</div>
                <div className="diagram-node" style={{top: '20%', left: '70%'}}>Analytics</div>
                <div className="diagram-node" style={{top: '80%', left: '30%'}}>Process</div>
                <div className="diagram-node" style={{top: '80%', left: '70%'}}>Output</div>
                
                {/* Connecting lines */}
                <div className="diagram-line" style={{top: '50%', left: '50%', width: '100px', transform: 'translate(-50%, -50%) rotate(-45deg)'}}></div>
                <div className="diagram-line" style={{top: '50%', left: '50%', width: '100px', transform: 'translate(-50%, -50%) rotate(45deg)'}}></div>
                <div className="diagram-line" style={{top: '50%', left: '50%', width: '100px', transform: 'translate(-50%, -50%) rotate(-135deg)'}}></div>
                <div className="diagram-line" style={{top: '50%', left: '50%', width: '100px', transform: 'translate(-50%, -50%) rotate(135deg)'}}></div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-12 text-lg leading-relaxed animate-on-scroll">
                Schedule a discovery call with our AI experts to explore how our solutions can address your specific business challenges.
              </p>
