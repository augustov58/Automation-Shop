      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:block">
            <a href="#contact" className="bg-white text-slate-900 px-4 py-2 rounded hover:bg-gray-200 transition">
              Get Started
            </a>
          </div>
        </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-slate-700">
            <nav className="flex flex-col space-y-4">
              ...
              <a href="#contact" className="bg-white text-slate-900 px-4 py-2 rounded hover:bg-gray-200 transition inline-block w-full text-center">
                Get Started
              </a>
            </nav>
          </div>
