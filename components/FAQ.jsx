...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Implementation timelines vary depending on the complexity of the solution and the specific needs of your business. Simple automation projects can be implemented in a few weeks, while more complex enterprise-wide solutions may take several months. We work closely with you to establish realistic timelines and ensure minimal disruption to your operations.',
  },
  {
    id: 'item-3',
    question: 'Do I need technical expertise to use your AI solutions?',
    answer:
      'No, our solutions are designed with user-friendliness in mind. While having technical staff can be beneficial, we provide comprehensive training and ongoing support to ensure your team can effectively use our AI tools regardless of their technical background. Our interfaces are intuitive and designed for business users.',
  },
  {
    id: 'item-4',
          ...
          <div className="space-y-4">
            {faqItems.map(item => (
              <div key={item.id} className="border-b border-slate-700 pb-4">
                ...
                {openItem === item.id && <div className="mt-2 text-slate-300">{item.answer}</div>}
              </div>
            ))}
          </div>
        </div>
