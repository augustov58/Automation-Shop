      ...
      {isSubmitted ? (
        ...
        >
          ...
          <p className="text-gray-300 mb-6">
            Your discovery call is scheduled for {formatDate(selectedDate)} at {selectedTime}.
        ...
        <div>
            ...
            {[1, 2, 3].map((i) => (
              <div 
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center relative z-10 ${
                  step >= i ? 'bg-[rgba(56,189,248,0.2)] border border-[rgba(56,189,248,0.5)]' : 'bg-gray-800 border border-gray-700'
                }`}
              >
                {step > i ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[rgba(56,189,248,0.8)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                ) : (
          ...
          <div className="flex justify-between mb-8 text-sm">
            <div className={`text-center w-1/3 ${step === 1 ? 'text-white' : 'text-gray-400'}`}>Select Date</div>
            <div className={`text-center w-1/3 ${step === 2 ? 'text-white' : 'text-gray-400'}`}>Select Time</div>
            <div className={`text-center w-1/3 ${step === 3 ? 'text-white' : 'text-gray-400'}`}>Your Details</div>
          </div>
          ...
          {step === 3 && (
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="message" className="block text-gray-300 mb-2">What would you like to discuss?</label>
                  <textarea 
                    id="message" 
                    name="message" 
